...
#' @export
legend_labels <- function(vars, lang, variables, ...) {
  UseMethod("legend_labels", vars)
}

#' @describeIn legend_labels q5 method
#' @export
legend_labels.q5 <- function(vars, lang = NULL, variables, ...) {
  title_left <-
    var_get_title(
...
#' @export
legend_labels.q100 <- function(vars, lang = NULL, variables, ...) {
  title_left <-
    var_get_title(
      var = vars$var_left, variables = variables, short_treshold = 25,
      translate = TRUE, lang = lang
...
#' @export
legend_labels.qual <- function(vars, lang = NULL, variables, ...) {
  title_left <-
    var_get_title(
      var = vars$var_left, variables = variables, short_treshold = 25,
      translate = TRUE, lang = lang
...
#' @export
legend_labels.bivar_ldelta_rq3 <- function(vars, lang = NULL, variables, time, ...) {
  title_left <-
    var_get_title(
  ...
  title_right <-
    var_get_title(
      var = vars$var_right, variables = variables, short_treshold = 16,
      translate = TRUE, lang = lang
    )
  title_right <- paste0(title_right, " (", time$var_right, ")")

  title_left_short <- var_get_info(
    var = vars$var_left, variables = variables, what = "var_short",
    translate = TRUE, lang = lang
  )
  title_right_short <- var_get_info(
    var = vars$var_right, variables = variables, what = "var_short",
    translate = TRUE, lang = lang
  )
...
#' @export
legend_labels.delta <- function(vars, lang = NULL, variables, time, ...) {
  title_left <-
    var_get_title(
      var = vars$var_left, variables = variables, short_treshold = 25,
      translate = TRUE, lang = lang
...
#' @export
legend_labels.bivar <- function(vars, lang = NULL, variables, ...) {
  title_left <-
    var_get_title(
...
#' @export
legend_labels.delta_bivar <- function(vars, lang = NULL, variables, time, ...) {
  title_left <-
    var_get_title(
      var = vars$var_left, variables = variables, short_treshold = 12,
      translate = TRUE, lang = lang
  ...
  title_right_short <- var_get_info(
    var = vars$var_right, variables = variables,
    what = "var_short", translate = TRUE,
    lang = lang
  )
